...
class UpdateWorking extends StatefulWidget {
  const UpdateWorking({Key? key}) : super(key: key);

  @override
  State<UpdateWorking> createState() => _UpdateWorkingState();
}

class _UpdateWorkingState extends State<UpdateWorking> {
  bool status1= false;
  bool status2= false;
  bool status3= false;
  bool status4= false;
