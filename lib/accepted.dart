                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(padding: EdgeInsets.only(top: 5, left: 13),
                            child: Text("Occasion- Birthday", style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.bold),),
                          )
                        ],
                      ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Padding(padding: EdgeInsets.only(top: 5, left: 15, right: 0),
                                    child: Text("25", style: TextStyle(fontSize: 14, color: Colors.black, fontWeight: FontWeight.bold),),
                                  )
                                ],
                              ),
                            ],
